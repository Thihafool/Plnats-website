        ...
        <div class="card">
            <div class="card-body">
                <form action="{{ route('admin#categoryUpdate') }}" method="post">
                    @csrf
                    <input type="hidden" name="categoryId" value="{{ $updateData->category_id }}">
                    <div class="form-group">
                        <label>Category Name</label>
                        <input type="text" name="categoryName" class="form-control "
                            value=" {{ old('categoryName', $updateData->title) }}" placeholder="Enter category name">
                        @error('categoryName')
                    ...
                    <div class="form-group">
                        ...
                        <textarea name="categoryDescription" class="form-control " placeholder="Enter category description" cols="30"
                            rows="10"> {{ old('categoryDescription', $updateData->description) }}</textarea>
